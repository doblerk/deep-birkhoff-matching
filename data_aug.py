...
class TripletGraphDataset(Dataset):
  ...
  def __init__(self, graphs, ged_labels, num_triplets=10000):
    self.graphs = graphs
  ...
  def _generate_triplets(self):
    ...
    for _ in range(self.num_triplets):
      anchor_idx = torch.randint(0, num_graphs - 1)
      ...
      a_node = torch.randint(0, anchor_graph.num_nodes - 1)
      p_node = torch.randint(0, pos_graph.num_nodes - 1)
      n_node = torch.randint(0, neg_graph.num_nodes - 1)
